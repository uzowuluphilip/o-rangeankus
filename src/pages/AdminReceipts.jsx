      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          {[
            ...
            { label: 'Posting Date', value: formatDate(transaction.posting_date || transaction.created_at) },
            { label: 'Value Date', value: formatDate(transaction.value_date || transaction.updated_at) },
          ].map(({ label, value }) => (
            <div
              key={label}
              style={{
